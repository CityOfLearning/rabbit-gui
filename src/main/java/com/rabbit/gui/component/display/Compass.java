...
public class Compass extends GuiWidget {
	...
	private final ResourceLocation EAST = new ResourceLocation("rabbit", "textures/gui/East Direction.png");
	private final ResourceLocation NORTH = new ResourceLocation("rabbit", "textures/gui/North Direction.png");
	private final ResourceLocation SOUTH = new ResourceLocation("rabbit", "textures/gui/South Direction.png");
	private final ResourceLocation WEST = new ResourceLocation("rabbit", "textures/gui/West Direction.png");
