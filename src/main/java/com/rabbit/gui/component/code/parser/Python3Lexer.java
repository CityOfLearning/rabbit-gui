...
public class Python3Lexer extends Lexer {
	...
	public static final int
		...
		SPACES=91, COMMENT=92, LINE_JOINING=93, UNKNOWN_CHAR=94;
	...
	public static final String[] ruleNames = {
		...
		"SPACES", "COMMENT", "LINE_JOINING", "UNKNOWN_CHAR", "SHORT_STRING", "LONG_STRING", 
